...
Once the grading scheme was agreed upon both group members read through all the articles separately, grading the articles. The grading were written into a document and the average was considered the final score. The whole article was read, in order to understand the whole content and intent of the article. The grading was very similar with few outliers. Any outliers were re-read and discussed together and if necessary. Once the final score was set any articles with a score of less than 7 were eliminated. This resulted in a set of articles who either focused on retrospectives or contained a high level of relevant discussion. This resulted in 19 articles that were considered relevant enough. This was considered a satisfactory amount of articles. Thus the article search ended.
...
\subsection{Techniques Identified}
...
\begin{table}[!h]
	\centering
	\captionsetup{justification=centering}
	\caption{An overview table of different retrospective exercises}
	\label{tabel:excercies_discussion}
	\begin{tabular}{p{0.3\textwidth} p{0.3\textwidth} p{0.1\textwidth} p{0.17\textwidth}}
	\hline
	Technique & Goal & Cost & Output \\ \hline
	Kj-Sessions & Identify issues & Low & A set of grouped issues \\ 
	Keep, Problem, Try & Identify issues & Low & One set of positive issues, one set of negative issues and one set of improvement actions. \\ 
	...
	Positive strokes & Individual feedback & Low & Individual feedback to each team member \\
	Timelines & Identify issues & Medium & Creates an understandable outline of the issues during the project phase \\
	Evidence based Timelines & Base issue identification on hard data. & Medium & Creates and understandable outline of the issues during project phase, but restrict the impact of memory bias \\
	Fishbone & Analyze issues & Low & A diagram visualizing a set of causes for a problem. \\
	Causal map analysis & Analyze issues & Low & Problem understanding \\
	\hline
	\end{tabular}
\end{table}
