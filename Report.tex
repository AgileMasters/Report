...
This statement interested us. The retrospective, a process in agile development that is responsible for software process improvement. That it is down-prioritized and is losing it benefits could be a hinder for development teams to improve. Based on this we decided to perform a literature review of the currently used retrospective practices from the existing research in retrospectives.
...
\begin{table}[!h]
	...
	\makebox[\textwidth]{%
		...
		\hline
		Retrospective & Postmortem, Project Release Review & The process of evaluating a software development process. \\
...
\begin{table}[!h]
	...
	\begin{tabular}{l p{0.8\textwidth}}
		...
		3. & Grouping the post-it notes to different views \\
...
\begin{figure}[h!]
	...
	\caption{An example post-it describing the finding from an article with the article number written in the lower right corner}
	\label{figure:postit}
\end{figure}
